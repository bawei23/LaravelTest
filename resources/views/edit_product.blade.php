                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="col-lg-12">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" id="price" class="form-control" value="{{$product->price}}" name="price" placeholder="99.90">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                    <div class="form-group focused">
                                        ...
                                        <textarea name="detail" id="detail" class="form-control" cols="30" rows="10">{{$product->detail}}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <input class="form-check-input" type="radio" name="publish" id="publish" value="1"  {{ ($product->publish=="1")? "checked" : "" }}>
                            ...
                            <div class="form-check">
                            <input class="form-check-input" type="radio" name="publish" id="publish" value="0" {{ ($product->publish=="0")? "checked" : "" }}>
                            <label class="form-check-label">
                                No
                            </label>
                            </div>
